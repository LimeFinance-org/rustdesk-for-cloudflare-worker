/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 88837cdc866b0f7623472f8aee272e1d)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 nodejs_compat
interface __BaseEnv_Env {
	DO_LOCATION_HINT: "apac";
	HBBR: DurableObjectNamespace<import("./src/index").Hbbr>;
	HBBS: DurableObjectNamespace<import("./src/index").Hbbs>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Hbbr" | "Hbbs";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DO_LOCATION_HINT">> {}
}
